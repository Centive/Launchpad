    ...
    if request.method == 'POST':
        ...
        if _signup_form.is_valid():
            ...
            if _user.objects.user_exists(_email):
                _signup_form.helper.form_error_title = 'This email you entered is already registered with us.'
                _signup_form.add_error(None,
                                       mark_safe('Do you want to <a href="' +
            ...
            if _signup_form.is_valid():
                ...
                if _user.objects.user_exists(_email):
                    ...
                    try:
                        ...
                        _signup_form.helper.form_error_title = 'Oops! Something went wrong :('
                        # TODO: Notify us of error
                        _signup_form.add_error(None, mark_safe('Please try again later'))
